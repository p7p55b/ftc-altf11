...
@TeleOp(name = "manual_final_v0.0.4")
...
// vérifie qu'on se soit pas en mode triangle
        while (sht == 0) {
...
// si le stick est a gauche, met le moteur droit à avancer, et le gauche a reculer
